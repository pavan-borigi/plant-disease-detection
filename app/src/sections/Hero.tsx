    ...
    >
        ...
        <div className="flex items-center gap-1">
          {heroConfig.navItems.map((item) => {
            ...
            return (
              <button
                key={item.sectionId}
                onClick={() => handleCtaClick(item.sectionId)}
      ...
      <div className="relative z-10 flex flex-col items-center justify-end h-full pb-20 px-4">
        ...
        <div className="flex gap-4">
          <button
            onClick={() => handleCtaClick(heroConfig.ctaPrimaryTarget)}
          ...
          <button
            onClick={() => handleCtaClick(heroConfig.ctaSecondaryTarget)}
      ...
      <div
        className={`fixed inset-0 bg-void-black z-[100] transition-opacity duration-500 pointer-events-none ${isTransitioning ? 'opacity-100' : 'opacity-0'
          }`}
      />
    </section>
  );
